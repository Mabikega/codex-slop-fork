...
const SLOP_FORK_AUTORESEARCH_TOOL_NAMES: [&str; 4] = [
    "autoresearch_init",
    "autoresearch_run",
    "autoresearch_log",
...
pub(crate) trait SlopForkAutoresearchToolsExt {
    fn with_slop_fork_autoresearch_tools(self, enabled: bool) -> Self;
    fn slop_fork_autoresearch_tools_enabled(&self) -> bool;
}

impl SlopForkAutoresearchToolsExt for ToolsConfig {
    fn with_slop_fork_autoresearch_tools(mut self, enabled: bool) -> Self {
        if enabled {
