...
impl AppCommand {
    ...
    pub(crate) fn slop_fork_pilot_turn(prompt: String) -> Self {
        Self::SlopForkPilotTurn { prompt }
    }

    pub(crate) fn slop_fork_autoresearch_turn(prompt: String) -> Self {
        Self::SlopForkAutoresearchTurn { prompt }
    }
